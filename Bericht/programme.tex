...
\lstinputlisting[firstline= 434, lastline=477,language = C++,frame=single,label=send(),caption=Bitstuffing]{
...
\lstinputlisting[firstline= 479, lastline=494,language = C++,frame=single,label=send(),caption=Senden einer Nachricht]{
	Kapitel/Programme/main.cpp}
...
\lstinputlisting[firstline= 271, lastline=326,language = C++,frame=single,label=recieve(),caption=Empfangen einer Nachricht]{
	Kapitel/Programme/main.cpp}
...
\lstinputlisting[firstline= 182, lastline=219,language = C++,frame=single,label=recieve(),caption=decodeBitstuffedMessage()]{
	Kapitel/Programme/main.cpp}

Zuletzt werden dann die einzelnen Teile der Nachrichten mit 'parseDecodedMessage' extrahiert.

\lstinputlisting[firstline= 223, lastline=268,language = C++,frame=single,label=recieve(),caption=parseDecodedMessage()]{
	Kapitel/Programme/main.cpp}
...
\lstinputlisting[firstline= 646, lastline=677,language = C++,frame=single,label=newAdress(),caption= Zuweisen einer neuen Adresse]{Kapitel/Programme/main.cpp}
...
\lstinputlisting[firstline= 710, lastline=729,language = C++,frame=single,label=timeout(),caption=Timeout Funktion]{Kapitel/Programme/main.cpp}
...
\lstinputlisting[firstline= 741, lastline=774,language = C++,frame=single,label=polling(),caption=Polling Funktion]{
	Kapitel/Programme/main.cpp}
...
\grqq) übermittelt.
\lstinputlisting[firstline= 631, lastline=643,language = C++,frame=single,label=usb(),caption=Datenübertragung an den angeschlossenen Computer]{
	Kapitel/Programme/main.cpp}
...
\lstinputlisting[firstline= 524, lastline=537,language = C++,frame=single,label=getAdress(),caption=Anfordern einer Adresse]{
	Kapitel/Programme/main.cpp}
...
\lstinputlisting[firstline= 539, lastline=568,language = C++,frame=single,label=myfunction(),caption=Beispiel Funktion Tastaturmodul]{Kapitel/Programme/main.cpp}
