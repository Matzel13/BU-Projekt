...
\lstinputlisting[firstline= 433, lastline=477,language = C++,frame=single,label=send(),caption=Bitstuffing]{
...
\lstinputlisting[firstline= 478, lastline=493,language = C++,frame=single,label=send(),caption=Senden einer Nachricht]{
	Kapitel/Programme/main.cpp}
...
\lstinputlisting[firstline= 222, lastline=268,language = C++,frame=single,label=recieve(),caption=parseDecodedMessage()]{
	Kapitel/Programme/main.cpp}
...
\grqq) übermittelt.
\lstinputlisting[firstline= 631, lastline=642,language = C++,frame=single,label=usb(),caption=Datenübertragung an den angeschlossenen Computer]{
	Kapitel/Programme/main.cpp}
