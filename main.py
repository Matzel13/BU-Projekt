...
# Vorschläge:
# - key_mappings in module umbennenen -> modularität beibehalten/zukünftige Module leichter einbinden
# - anstelle von Module 1 als name die adresse nutzen
# - am anfang der polling runde kommt eine liste aller angeschlossenen module, diese durchgehen und noch nicht vorhandene module erstellen und im dict speichern
    ...
    while True:
        try:
           ...
           # if message:
            ...
            if i == 1:
                adresse = message
                loaded_module = key_mappings[adresse]
                i += 1
        
            if i > 1:
                # do what should happen according to the keymapping
                print(f"Hier jetzt auswertung der Message: {message} einbauen.")
